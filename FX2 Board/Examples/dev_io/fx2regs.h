...
//begin user added
/* EP 2468 Configuration */
#define bmVALID		bmBIT7
#define bmDIR		bmBIT6
#define bmTYPE1		bmBIT5
#define	bmTYPE0		bmBIT4
#define	bmTYPEMASK	(bmTYPE1 | bmTYPE0)
#define	bmSIZE		bmBIT3
#define	bmBUF1		bmBIT1
#define	bmBUF0		bmBIT0
#define	bmBUFMASK	(bmBUF1 | bmBUF0)

// Chip Revision Control Register (REVCTL)
#define bmDYNOUT	bmBIT1
#define bmENHPKT	bmBIT0
//end user added
