...
%			\draw[<->,ultra thick]([yshift=10]pc.east) -- node (data)[above]{Datos} ([yshift=10]adq.west);
%			\draw[<->,ultra thick]([yshift=-15]pc.east) -- node (ctrl)[above]{Control} ([yshift=-15]adq.west);
%			\end{scope}
%			\begin{scope}[on background layer]
%				\node[rounded rectangle,fill=red!30,fit=(pc.south east)(adq.north west)(data)(ctrl)]{};
%			\end{scope}				
%			\end{tikzpicture}}
%		\only<2>{\includegraphics[width=0.9\paperwidth]{01motivacion}}
	\end{frame}
	\begin{frame}{Agenda}
