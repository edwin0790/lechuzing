...
\usepackage{listings}
\usepackage{tikz}
\usetikzlibrary{arrows,babel,backgrounds,circuits.logic.mux,circuits.logic.US,decorations.pathreplacing,fit,patterns,petri,positioning,shapes,shapes.gates.logic,trees}
