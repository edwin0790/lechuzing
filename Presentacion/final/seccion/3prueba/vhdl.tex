...
\begin{frame}{Verificación Funcional}
	...
	\only<9>{\includegraphics[width=\textwidth]{sist_tb_pktend00}}
	\only<10>{\includegraphics[width=\textwidth]{sist_tb_pktend01}}
	\only<11>{\includegraphics[width=\textwidth]{sist_tb_pktend02}}
	\only<12>{\includegraphics[width=\textwidth]{sist_tb_pktend03}}
\end{frame}
