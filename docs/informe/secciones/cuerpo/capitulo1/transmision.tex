...
Pero, ¿Cuántos datos son suficientes para el propósito de trasmitir imágenes? Se toma como base de diseño el sensor que utiliza Pérez en su Tesis de Maestría \cite{Perez2018}, una cámara para adquirir imágenes monocromáticas de código MT9M001C12STM, comercializado por Actina Imaging \cite{MicronTechnology2004}. Este sensor posee 1480x1024 pixeles, con profundidad de 10 bits y puede operar hasta a 30 cuadros por segundo. Todo esto, otorga la necesidad de una tasa aproximada de \SI{393.2}{\mega\bit\per\second}. Esta tasa de bits es suficiente comparada, por ejemplo, con las señales de Televisión Digital. El estándar más exigente de la norma americana de la SCTE (Sociedad de Ingenieros de Comunicación por Cable), posee una tasa de \SI{38.8}{\mega\bit\per\second}\cite{SocietyofCableTelecommuniocationsEngineers2006}.\\
