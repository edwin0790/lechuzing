...
\subsubsection*{Las herramientas que adquieren y procesan datos}
...
Esto da lugar a que se encuentren en desarrollo un gran número de sensores que permitan obtener flujos crecientes de datos. Un sensor es un dispositivo a través del cual se adquiere una variable física y se transforma en un valor registrable. Para nuestro propósito, el transductor debe entregar un valor proporcional de corriente y/o tensión, en función de la propiedad física que se desea conocer. Un sensor consta de un transductor, es decir, el elemento que transforma una variable física en otra, y de un sistema que convierta lo que se observa en el transductor en una señal eléctrica, si el transductor no la otorga por si mismo.\\

Uno de los desarrollo que se encuentra actualmente en boga es el de sensores y sistemas que adquieran imágenes de diferentes tipos. Un sensor de imagen puede estar compuesto, bien por un arreglo bidimensional de transductores, o bien por un transductor que es barrido y leído. Para ambos casos, es de suma utilidad que la lectura de imágenes sea realizada en el menor tiempo posible.\\
