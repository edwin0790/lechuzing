	...
	\begin{tikzpicture}[scale=1,>=latex]
		\begin{scope}
			\begin{scope}[transform shape,node distance=.15]
				\node[pid]	(pidtok)	{T.\\\ \\P\\I\\D};
				\node[dir]	(adtok)	[right=of pidtok]	{D\\i\\r.};
				\node[dir]	(eptok)	[right=of adtok]	{E\\x\\t\\r.};
				\node[crc]	(crc5)	[right=of eptok]	{R\\e\\c\\o\\n.};
			\end{scope}
			\begin{scope}
				\node[exterior,minimum size=0,inner sep=1,fit=(adtok)(eptok)](tokad){};
				\node[below=.01 of tokad.south,align=center] (texttok){Paquete Token};
				\node[exterior,inner sep=1,fit=(pidtok)(tokad)(crc5)(texttok)]{};
			\end{scope}
			\begin{scope}[transform shape,node distance=.15]
				\node[pid]	(piddat)	{D.\\\ \\P\\I\\D};
%TODO revisar de aca en adelate todo
				\node[data]	(da)	[right=of piddat]	{D\\i\\r.};
				\node[dir]	(eptok)	[right=of adtok]	{E\\x\\t\\r.};
				\node[crc]	(acktok)[right=of eptok]	{CRC5};
			\end{scope}
			\begin{scope}
				\node[exterior,minimum size=0,inner sep=1,fit=(adtok)(eptok)](tokad){};
				\node[below=.01 of tokad.south,align=center,transform shape] (texttok){Paquete Token};
				\node[exterior,inner sep=1,fit=(pidtok)(tokad)(acktok)(texttok)]{};
			\end{scope}			
		\end{scope}
	\end{tikzpicture}
\end{document}